...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ConversationListActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((ConversationListActivity) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			if (((ConversationListActivity) activity).playMsgId != null && ((ConversationListActivity) activity).playMsgId.equals(message.getMsgId())) {
